defmodule ItaclimbWeb.PostControllerTest do
  use ItaclimbWeb.ConnCase

  import Itaclimb.BlogFixtures

  @create_attrs %{title: "some title", body: "some body", views: 42, slug: "some slug", published_at: ~U[2026-02-27 13:34:00Z]}
  ...
  describe "index" do
    test "lists all posts", %{conn: conn} do
      ...
      assert html_response(conn, 200) =~ "Notícias da"
    end
  end
