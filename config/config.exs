...
config :itaclimb, ItaclimbWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ItaclimbWeb.ErrorHTML, json: ItaclimbWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Itaclimb.PubSub,
  live_view: [signing_salt: "bUk2btda"]
...
config :itaclimb, Itaclimb.Mailer, adapter: Swoosh.Adapters.Local
